...
public class LocalIntercepter implements Interceptor {
    private static final String TAG = LocalIntercepter.class.getSimpleName();
    private static final String FILE_EXTENSION = ".json";
    private Context mContext;

    private String mContentType = "application/json";

    public LocalIntercepter(Context context) {
        mContext = context;
    }
     ...
     */
    public LocalIntercepter setContentType(String contentType) {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (responseFileName != null) {
            ...
            Log.d(TAG, "Read com.de.data from file: " + fileName);
            try {
